		...
		<div id="container" class="clearfix">
			...
			<div id="full-content">
				...
				<div id="index">
					...
					<div id="greetings">
						<p class="text-xlarge">
							<span class="bold">안녕하세요♡<br> 이정화의 MySite에 오신 것을
								환영합니다<br> <br> 이 사이트는 Web programming 실습 과제 예제 사이트입니다.<br>
							</span> <br> 사이트 소개, 회원가입, 방명록, 게시판으로 구성되어 있으며,<br>
							spring framework 기반으로 제작되었습니다.<br> <br> java  + database
							+ 웹 프로그래밍 <br>수업에서 배운 내용들을 토대로 만들었습니다.<br>
							<br> 
							<br>
